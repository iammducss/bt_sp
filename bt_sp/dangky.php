...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/1136.b3c5b80d09b052dd.css">
    <link rel="stylesheet" type="text/css"
...
<body class="">
    ...
    <div class="vtexOX">
        <nav class="axexMF">
            ...
            <a href="https://facebook.com/use.ducdz" class="ZKvYoG">Bạn cần giúp đỡ?</a>
        </nav>
        <div style="background-color: rgb(255, 235, 225);">
            <div class="_3M9lzn PeA8Gc"
                ...
                <div class="zfewkl">
                    ...
                    <div class="YJ0kaz J1i6cp B-fiUo">
                                    ...
                                    <div>
                                        <div class="qvdx4B">
                                            <div class="yup5K8"><input class="pDzPRp" type="text"
                                                    placeholder="Email/tên đăng nhập" autocomplete="tel" name="usename"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="qvdx4B">
                                            <div class="yup5K8"><input class="pDzPRp" type="tel"
                                                    placeholder="Số điện thoại" autocomplete="tel" name="sdt" value="">
                                            </div>
                                        </div>
                                        <div class="qvdx4B">
                                            <div class="yup5K8"><input class="pDzPRp" type="password"
                                                    placeholder="Nhập mật khẩu" autocomplete="pass" name="password"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="qvdx4B">
                                            <div class="yup5K8"><input class="pDzPRp" type="password"
                                                    placeholder="Nhập lại mật khẩu" autocomplete="pass"
                                        ...
                                        <a href="dangnhap.php">
                                            <button class="wyhvVD _1EApiB hq6WM5 L-VL8Q KgaLSo cepDQ1 _7w24N1"
                                                type="submit" name="btn-reg" onclick="sub()">Đăng
                                                ký</button>
                                        </a>
                        ...
                        <div class=" x3TVMM">
                            ...
                            <div class="_3051nA"><button class="bx8TqH lyJbNT bQ2eCN">
                                    <div class="Bq4Bra">
                                        <div class="_1a550J social-white-background social-white-fb-blue-png">
                                        </div>
                                    </div>
                                    <div class="">Facebook</div>
                                </button><button class="bx8TqH lyJbNT bQ2eCN">
                                    <div class="Bq4Bra">
                                        <div class="_1a550J social-white-background social-white-google-png">
                                        </div>
                                    </div>
                    ...
                    <div class="Oug9xv Z8OMtU" style="margin-bottom: 10%;">Bạn đã có tài khoản? <a class="wzgwUg"
    ...
    <footer class="hZqP02">
        <div class="jP2PzH">
            <div class="ibAPxC">
                ...
                <div class="PuXQrZ">
                    ...
                    <ul class="SOb2n7">
                        <li class="o8Gbgv"><a href="https://www.facebook.com/ShopeeVN" class="FA0WjS" title=""
        ...
        <div class="_4FDN71">
            <div class="Hyfopi">
                <div class="EWPRwa">
                    <div class="d56atc"><a class="Dc8l4L" href=""><span>Chính sách bảo
                                mật</span></a></div>
                    <div class="d56atc"><a class="Dc8l4L" href=""><span>Quy chế hoạt
                                động</span></a></div>
                    <div class="d56atc"><a class="Dc8l4L" href=""><span>Chính sách vận
                                chuyển</span></a></div>
                    <div class="d56atc"><a class="Dc8l4L" href=""><span>CHÍNH SÁCH TRẢ HÀNG VÀ
                ...
                <div class="BV2E6Y">Chịu Trách Nhiệm Quản Lý Nội Dung: Nguyễn Đức Trí - Điện thoại liên hệ:
                    024 73081221 (ext 4678)</div>
                <div class="BV2E6Y">Mã số doanh nghiệp: 0106773786 do Sở Kế hoạch &amp; Đầu tư TP Hà Nội cấp
